...
CONSTRAINT REL_VISITORZONEACCESS_VISITORPERMIT FOREIGN KEY(PERMITNO) REFERENCES VISITORPERMIT(PERMITNO) ON DELETE CASCADE,
...
ZONEID CHAR(5) NOT NULL,
PRIMARY KEY(PERMITNO, ZONEID),
CONSTRAINT REL_NONVISITORZONEACCESS_ZONE FOREIGN KEY(ZONEID) REFERENCES ZONE(ZONEID) ON DELETE CASCADE,
CONSTRAINT REL_NONVISITORZONEACCESS_NONVISITORPERMIT FOREIGN KEY(PERMITNO) REFERENCES NONVISITORPERMIT(PERMITNO) ON DELETE CASCADE,
